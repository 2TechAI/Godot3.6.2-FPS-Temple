...
func _health_hud() -> void:
	if character and weapon_hud.has_node("health"):
		var health_label = weapon_hud.get_node("health");
		health_label.text = "HP: " + str(character.health) + " | " + str(character.max_health);
		if character.health < 20:
			health_label.add_color_override("font_color", Color("#ff0000"));
		elif character.health < 50:
			health_label.add_color_override("font_color", Color("#dd761b"));
		else:
			health_label.add_color_override("font_color", Color("#00ff00"));
